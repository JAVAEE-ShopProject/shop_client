...
<%@ page import="com.igeek.shop.pojo.Order" %>
...
<%
	...
	String subject = order.getOrderItems().get(0).getProduct().getPname();
	String body = order.getOrderItems().get(0).getProduct().getPdesc();
