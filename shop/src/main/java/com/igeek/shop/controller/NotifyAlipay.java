...
import com.igeek.shop.utils.AlipayConfig;
...
/**
 * @author ：Allen
 * @date ：Created in 2021/1/30 22:13
 * @description：
 * @version: 1.0
 */
@WebServlet(name = "NotifyAlipay", urlPatterns = "/notify")
public class NotifyAlipay extends HttpServlet {
...
//                System.out.println("支付成功");
                ...
                //付款完成后，支付宝系统发送该交易状态通知
                //session域中的数据会失效
                Order order = orderService.queryOrderByOid(out_trade_no);
                order.setState(1);
